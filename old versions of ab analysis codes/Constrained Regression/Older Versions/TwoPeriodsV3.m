...
for FirstOrSecond=1:2
    ...
    ApraisalRatio{FirstOrSecond}=mean(SameVolMonthlyActualAlpha{FirstOrSecond})/std(SameVolMonthlyActualAlpha{FirstOrSecond});
...
if NFirstHalf==NMonth
    ...
    Legend4=legend('Subperiod 1 Trials',['Subperiod 1 Best Fit,AR=',num2str(VolAdjAR{1})]);
else
    Legend4=legend('Subperiod 1 Trials','Subperiod 2 Trials',['Subperiod 1 Best Fit,AR=',num2str(VolAdjAR{1})],['Subperiod 2 Best Fit,AR=',num2str(VolAdjAR{2})]);
end
