...
if NFirstHalf==NMonth
    ...
    Legend4=legend('Subperiod 1 Trials',['Subperiod 1 Best Fit,AR=',num2str(ApraisalRatio{1})]);
else
    Legend4=legend('Subperiod 1 Trials','Subperiod 2 Trials',['Subperiod 1 Best Fit,AR=',num2str(ApraisalRatio{1})],['Subperiod 2 Best Fit,AR=',num2str(ApraisalRatio{2})]);
end
