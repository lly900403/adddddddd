...
for FirstOrSecond=1:2
    ...
    %VolAdjARDist{FirstOrSecond}=VolAdjAlphaDist{FirstOrSecond}./std(VolAdjAlphaDist{FirstOrSecond});
    ...
    %VolAdjAR{FirstOrSecond}=VolAdjARDist{FirstOrSecond}(:,SelectedTrial{FirstOrSecond});
end
%% =====================================================================
...
text(-MaxAbsReturn,MaxAbsReturn,['Out of Sample Correlation: ',num2str(SecondCorr(1,2),'%.4f')],...                              % Dsiplay R-square
     'VerticalAlignment','top','FontWeight','bold');
text(-MaxAbsReturn,MaxAbsReturn*0.9,['In Sample Correlation: ',num2str(FirstCorr(1,2),'%.4f')],...                              % Dsiplay R-square
     'VerticalAlignment','top','FontWeight','bold');
...
if NFirstHalf==NMonth
    % Legend4=legend('In Sample Trials','In Sample Best Fit');
    Legend4=legend('In Sample Trials',['In Sample Best Fit,AR=',num2str(ApraisalRatio{1})]);
else
    Legend4=legend('In Sample Trials','Out of Sample Trials',['In Sample Best Fit,AR=',num2str(ApraisalRatio{1})],['Out of Sample Best Fit,AR=',num2str(ApraisalRatio{2})]);
end
